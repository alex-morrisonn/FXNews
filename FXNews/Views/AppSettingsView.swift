            ...
            VStack(alignment: .leading, spacing: 18) {
                ...
                Button {
                    ...
                    settingsActionButtonLabel(
                        ...
                        tint: notificationAuthorizationStatus == .denied ? Color.orange.opacity(0.82) : FXNewsPalette.accent
                    )
                }
                .buttonStyle(.plain)
...
enum AppExternalLinks {
    static let supportPageURL = "https://fxnews.app/support/index.html"
    static let supportEmailURL = "mailto:fxnews.app@gmail.com?subject=FX%20News%20Support"
    static let privacyPolicyURL = supportPageURL + "#privacy"
    static let termsOfServiceURL = supportPageURL + "#terms"
    static let supportURL = supportPageURL
}
...
private struct FXNewsToggleRow: View {
    let title: String
    let subtitle: String
